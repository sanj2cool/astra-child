...
<div class="tutor-wrap tutor-full-width-course-top tutor-course-top-info tutor-page-wrap tutor-wrap-parent  courses type-courses status-publish hentry course-category-developers course-category-github-copilot ast-article-single pink-sec">
...
<div class="tutor-wrap tutor-full-width-course-top tutor-course-top-info tutor-page-wrap tutor-wrap-parent  courses type-courses status-publish hentry course-category-developers course-category-github-copilot ast-article-single">
    <div class="tutor-container">                 
   <div class="tutor-row tutor-gx-xl-5">
		<div class="tutor-col-xl-12 tutor-mt-32">
                    <?php  ?>
      </div> 
      </div>  
      </div>  
